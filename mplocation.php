...
<body>
    ...
    <div class="container">
        ...
        class MPLocation extends RecursiveIteratorIterator {
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT DISTINCT name FROM MotionPicture mp JOIN Location l ON mp.id=l.mpid WHERE l.country=:searchTerm;");
            ...
            {
            echo "<h1>Motion Pictures in country</h1>";
            ...
            echo "<tr><th class='col-md-2'>Motion picture</th></tr></thead>";
                ...
                foreach(new MPLocation(new RecursiveArrayIterator($stmt->fetchAll())) as $k=>$v) {
                    echo $v;
                }
            }
        }

...
<body>
    ...
    <div class="container">
        ...
        class MPName extends RecursiveIteratorIterator {
        ...
        try {
            ...
            $searchTerm = $_POST['mname'];
            // prepare statement for executions. This part needs to change for every query
            // Search Motion Picture by Motion picture name (parameterized). List the movie name, rating, production, and budget.
            $stmt = $conn->prepare("SELECT name, rating, production, budget FROM MotionPicture mp JOIN Movie m ON mp.id=m.mpid WHERE mp.name LIKE :searchTerm;");
            ...
            echo "<tr><th class='col-md-2'>Movie name</th>
                ...
                foreach(new MPName(new RecursiveArrayIterator($stmt->fetchAll())) as $k=>$v) {
                    echo $v;
                }
            }
        }
